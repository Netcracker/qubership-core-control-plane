...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "domain.NodeGroup": {
            ...
            "properties": {
                "forbidVirtualHosts": {
                    "description": "ForbidVirtualHosts indicates whether registering virtual hosts for this gateway is forbidden.\nNegative form is chosen to represent default value easily - ` + "`" + `false` + "`" + ` is default.",
                    "type": "boolean"
                },
                "gatewayType": {
        ...
        "domain.StatefulSession": {
            ...
            "properties": {
                "clusterName": {
                    "description": "ClusterName here is a microservice family name, NOT cluster key: no port included! E.g. ` + "`" + `trace-service` + "`" + `.",
                    "type": "string"
                },
                "cookieName": {
                    "type": "string"
        ...
        "dto.StatefulSession": {
            ...
            "properties": {
                ...
                "route": {
                    "description": "Route is RO field to return in GET StatefulSession response. Ignored in requests.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/dto.RouteMatcher"
                        }
