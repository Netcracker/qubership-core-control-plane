...
require (
	...
	github.com/netcracker/qubership-core-lib-go-dbaas-postgres-client/v4 v4.0.6
	github.com/netcracker/qubership-core-lib-go-error-handling/v3 v3.1.0
	github.com/netcracker/qubership-core-lib-go-fiber-server-utils/v2 v2.1.2
	github.com/netcracker/qubership-core-lib-go-rest-utils/v2 v2.1.2
