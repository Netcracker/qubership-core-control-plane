...
require (
	...
	github.com/netcracker/qubership-core-lib-go-dbaas-postgres-client/v4 v4.3.1
	github.com/netcracker/qubership-core-lib-go-error-handling/v3 v3.4.0
	github.com/netcracker/qubership-core-lib-go-fiber-server-utils/v2 v2.5.1
	github.com/netcracker/qubership-core-lib-go-rest-utils/v2 v2.4.1
	github.com/netcracker/qubership-core-lib-go-stomp-websocket/v3 v3.4.1
